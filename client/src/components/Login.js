...
export default function Login() {
    ...
    const signInWithGoogle = () => { // code that allows user to log in with their google account
    ...
    const register = async (e) => { // code that allows user to register with an email and password
        try {
            e.preventDefault();
    ...
    const login = async (e) => { // code that allows user to login with registered email and password
        try {
            e.preventDefault();
